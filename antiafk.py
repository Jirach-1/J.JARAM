...
class AntiAFK:
    ...
    def perform_antiafk_action(self, hwnd, action_type=None):
        ...
        try:
            ...
            if self.config.get("antiafk_menu_autoreconnect", False) and self.is_pid_in_menu_callback:
                try:
                    in_menu = self.is_pid_in_menu_callback(int(pid))
                except Exception:
                    in_menu = None
                if in_menu is True:
            ...
            while not self.antiafk_stop_event.is_set():
                try:
                    ...
                    if perform_action:
                        ...
                        action_success = True
                        # Always apply Anti-AFK to all detected Roblox windows.
